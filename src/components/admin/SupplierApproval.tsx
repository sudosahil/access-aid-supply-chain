    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Review and approve supplier registrations</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
                          ...
                          {selectedSupplier && (
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-1">
                                  {selectedSupplier.complianceDocuments.map((doc, index) => (
                                    <Badge key={index} className="bg-blue-100 text-blue-800">{doc}</Badge>
                                  ))}
                                </div>
                              </div>
