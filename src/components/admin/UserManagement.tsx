      ...
      <Card>
        <CardHeader className="bg-slate-300">
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription className="text-gray-950">Manage system users and their roles</CardDescription>
            </div>
        ...
        <CardContent className="bg-slate-300">
          ...
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="bg-zinc-950">Name</TableHead>
                <TableHead className="bg-zinc-950">Email</TableHead>
                <TableHead className="bg-zinc-950">Role</TableHead>
                <TableHead className="bg-zinc-950">Phone</TableHead>
                <TableHead className="bg-gray-950">Status</TableHead>
                <TableHead className="bg-gray-950">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredUsers.map(user => <TableRow key={user.id}>
                  ...
                  <TableCell>
                    <div className="flex space-x-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => handleDeactivateUser(user.id)} disabled={!user.isActive}>
