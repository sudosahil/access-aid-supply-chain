          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">SSEPD Procurement & Inventory Management</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3 pl-4 border-l border-blue-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="text-sm text-slate-500">
              Welcome, {user.name} | Role: <span className="font-medium text-sky-600 capitalize">{user.role}</span>
            </div>
          </div>
        </div>
      </div>
