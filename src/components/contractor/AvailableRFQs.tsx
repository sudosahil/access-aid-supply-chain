...
export const AvailableRFQs = ({ contractorId }: AvailableRFQsProps) => {
  ...
  const handleSubmitBid = () => {
    ...
    setBidData({ amount: '', proposal: '', documents: '' });
    toast({
      title: "Bid Submitted",
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and submit bids for open RFQs</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {openRFQs.map((rfq) => (
                <TableRow key={rfq.id}>
                  ...
                  <TableCell>
                    {getBidStatus(rfq.id) ? (
                      <Badge className={getStatusColor(getBidStatus(rfq.id)!)}>
                          ...
                          <DialogContent>
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <Input
                                  id="documents"
                                  value={bidData.documents}
                                  onChange={(e) => setBidData({ ...bidData, documents: e.target.value })}
